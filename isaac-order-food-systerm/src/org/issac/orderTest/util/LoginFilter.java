package org.issac.orderTest.util;
...
import org.issac.orderAppTest.service.UserService;
import org.issac.orderAppTest.service.UserServiceImpl;
...
public class LoginFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		//得判断要去前台还是后台的登录页面  获取请求地址，如/orderTest/sys/index.action
