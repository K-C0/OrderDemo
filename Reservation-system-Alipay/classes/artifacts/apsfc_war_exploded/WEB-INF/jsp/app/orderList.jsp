							...
							<div class="sidebar-row">
								...
								<span class="col-md-2">
									<font color="#0096e6">
										...
										<font color="#0096e6">总计:￥ <fmt:formatNumber value="${order.totalPrice}" pattern="0.00"></fmt:formatNumber></font>
									</font>
								</span>
								<span class="col-md-2">
									<!-- 订单id -->
									<c:if test="${order.orderStatus == 0 && order.disabled == 0 && (session_user.id == order.creatUserId || session_user.roleId ==0)}">
										<!-- 参数为订单id -->
